...
const RegisterForm: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!kunde.adresseStrasse.trim()) newErrors.adresse = 'Straße ist erforderlich.';
    ...
    const composedAdresse = composeAdresse(
      kunde.adresseStrasse,
      kunde.adressePlz,
      kunde.adresseOrt
    );
    ...
    const kundeToSend = {
      ...kunde,
      adresse: composedAdresse,
    } as any;
    delete kundeToSend.confirmPassword;
    delete kundeToSend.agb;
    delete kundeToSend.datenschutz;
    delete kundeToSend.adresseStrasse;
    delete kundeToSend.adressePlz;
    delete kundeToSend.adresseOrt;
                    ...
                    <div className="row g-2">
                      <div className="col-md-6">
                        <input
                          ...
                          value={kunde.adresseStrasse}
                          onChange={e => setKunde({ ...kunde, adresseStrasse: e.target.value })}
                          required
                        />
                      </div>
                      <div className="col-md-3">
                        <input
                          ...
                          placeholder="PLZ"
                          value={kunde.adressePlz}
                          onChange={e => setKunde({ ...kunde, adressePlz: e.target.value })}
                        />
                      </div>
                      <div className="col-md-3">
                        <input
                          ...
                          className="form-control form-control-lg"
                          placeholder="Ort"
                          value={kunde.adresseOrt}
                          onChange={e => setKunde({ ...kunde, adresseOrt: e.target.value })}
                        />
                      </div>
                    </div>
                    {errors.adresse && <div className="invalid-feedback d-block">{errors.adresse}</div>}
