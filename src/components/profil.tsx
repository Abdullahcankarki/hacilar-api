        ...
        <div className="row pt-md-2 pt-lg-3 pb-sm-2 pb-md-3 pb-lg-4 pb-xl-5">
            ...
            <div className="offcanvas-lg offcanvas-start pe-lg-0 pe-xl-4" id="accountSidebar">
              <div className="offcanvas-header d-lg-block py-3 p-lg-0">
                <div className="d-flex align-items-center">
                  <div className="d-flex justify-content-center align-items-center bg-light border rounded-circle mb-0" style={{ width: '3.5rem', height: '3.5rem' }}>
          ...
          <div className="col-lg-9">
            <div className="ps-lg-3 ps-xl-0">
              <h1 className="h2 mb-4 mb-sm-4">Personal Info</h1>
              ...
              {/* Passwort ändern */}
              <div className="card card-body bg-light border-0 py-4 mb-4">
                <div className="nav d-flex justify-content-between align-items-center pb-1 mb-3">
              ...
              {/* Konto löschen */}
              <div className="card card-body border-danger bg-light-subtle mt-4">
                ...
                <button className="btn btn-danger w-100" onClick={() => alert("Bitte kontaktiere den Administrator zur Kontolöschung.")}>
                  Konto löschen
                </button>
              </div>
            </div>
