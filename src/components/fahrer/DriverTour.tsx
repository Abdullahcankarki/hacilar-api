...
import { getAllTours, updateTour, listTourStops, updateTourStop, getFahrzeugById, setAuftragInFertig } from "@/backend/api";
...
export default function DriverTour() {
    ...
    async function onCompleteStop() {
        ...
        try {
            ...
            await setAuftragInFertig(activeStop.auftragId);
            resetProofForms();
